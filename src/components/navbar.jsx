      ...
      <div className={`flex gap-2 items-center w-full justify-between px-3 py-1 z-50 mb-2 fixed ${scrolled ? 'bg-white' : 'bg-transparent'} mx-auto transition-all duration-500 m-0`}>
         <div className="col">
            <form className="flex items-center mx-auto w-full">
               ...
               <button type="submit" className="p-2.5 ms-2 text-sm font-medium text-white bg-primary rounded-lg border border-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-orange-300 dark:bg-blue-600 ">
